          ...
          <div className="flex-1">
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-surface-container-low p-8 rounded-xl border border-outline-variant" onSubmit={handleCheckout}>
              <div className="md:col-span-2">
                <label className="block text-label-md font-label-md mb-2 text-on-surface" htmlFor="input_1">Numero do cartão</label>
                <input
              ...
              <div className="md:col-span-2">
                <label className="block text-label-md font-label-md mb-2 text-on-surface" htmlFor="input_2">Nome</label>
                <input
                  className="w-full p-3 bg-surface border border-outline-variant rounded focus:border-primary focus:ring-1 focus:ring-primary outline-none text-body-md transition-all"
                  id="input_2"
                  name="input_2"
              ...
              <div>
                <label className="block text-label-md font-label-md mb-2 text-on-surface" htmlFor="input_3">Validade</label>
                <input
                  className="w-full p-3 bg-surface border border-outline-variant rounded focus:border-primary focus:ring-1 focus:ring-primary outline-none text-body-md transition-all"
                  id="input_3"
                  name="input_3"
              ...
              <div>
                <label className="block text-label-md font-label-md mb-2 text-on-surface" htmlFor="input_4">CVV</label>
                <input
                  className="w-full p-3 bg-surface border border-outline-variant rounded focus:border-primary focus:ring-1 focus:ring-primary outline-none text-body-md transition-all"
                  id="input_4"
                  name="input_4"
